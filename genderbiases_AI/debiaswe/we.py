...
def viz(analogies):
    for i, a in enumerate(analogies):
        # Assuming 'a' is a tuple like ('اداکارہ', 'اداکار', similarity_score)
        # Note: Adjusted string formatting for right alignment of Urdu text.
        print(f"{str(i).rjust(4)}{a[0].rjust(15)} | {a[1].ljust(15)} {str(a[2])[:4]}")
